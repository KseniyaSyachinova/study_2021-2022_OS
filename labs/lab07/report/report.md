...
![Открытие команды](image/2.png){ #fig:002 width=50% }

![Левая панель](image/3.png){ #fig:003 width=50% }

![Файл](image/4.png){ #fig:004 width=50% }

![Команда](image/5.png){ #fig:005 width=50% }

![Настройки](image/6.png){ #fig:006 width=50% }

![Левая панель](image/7.png){ #fig:007 width=50% }

![Помощь](image/8.png){ #fig:008 width=50% }
